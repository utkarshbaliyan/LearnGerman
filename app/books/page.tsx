...
export default function BooksPage() {
  return <div className="site-shell"><SiteHeader active="books" /><main className="book-library">
    ...
    <section className="book-library-feature" aria-labelledby="book-title"><div className="book-cover" aria-hidden="true"><BookOpen size={44} /><span>A1</span><strong>Unser Leben in Lindenstadt</strong></div><div><span className="reading-eyebrow">A1 · Continued story</span><h1 id="book-title" lang="de">{A1_BOOK.title}</h1><p lang="de">{A1_BOOK.subtitle}</p><p>Read in page order or jump to a chapter. There are no quizzes in this book.</p><Link className="reading-primary" href="/books/a1/unser-leben-in-lindenstadt/1">Start reading <ArrowRight size={18} /></Link></div></section>
