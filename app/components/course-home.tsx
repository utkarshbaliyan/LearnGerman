...
const LearningProgressOverview = lazy(() => import("@/app/components/learning-progress-overview").then((module) => ({ default: module.LearningProgressOverview })));
...
export function CourseHome({
  ...
  return (
    <main className="site-shell course-home" id="top">
      ...
      <Suspense fallback={<section className="learning-progress-overview" aria-label="Loading learning progress" />}><LearningProgressOverview completedChapters={completedChapters} chapterTotal={publishedLessons.length} grammarLessonIds={publishedLessons.map((lesson) => lesson.id)} courseReady={hydrated} /></Suspense>
