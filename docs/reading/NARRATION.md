...
- Length scale 1.0; 150 ms of inserted silence between synthesis chunks; mono AAC at 38 kb/s, which fits the site's media limit while retaining the same voice model and broad browser support. The full recording plays continuously, without starting a new browser utterance at every sentence.
